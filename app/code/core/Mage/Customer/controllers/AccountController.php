...
//        }
                ...
                if ($this->getRequest()->getPost('create_shipping_address')) {
                    ...
                    $addressForm->setFormCode('customer_register_address')
                        ...
                        $shippingAddressData = array(
                                ...
                                'number'     => $this->getRequest()->getPost('shipping_number'),
                                'apartment'  => $this->getRequest()->getPost('shipping_apartment'),
                                //'floor'      => $this->getRequest()->getPost('shipping_floor'),
                                'country_id' => 'PL',
                                );
    ...
    protected function _welcomeCustomer(Mage_Customer_Model_Customer $customer, $isJustConfirmed = false)
    {
        $this->_getSession()->addSuccess(
            $this->__('<h1>Dziękujemy za rejestrację.</h1><br />Na podany przez Ciebie adres e-mail zostało wysłane potwierdzenie.')
    ...
    public function recommendAction()
    {
        ...
        $block = $this->getLayout()->getBlock('customer_recommend');
        if ($block) {
            $block->setRefererUrl($this->_getRefererUrl());
        }
    ...
    public function statusAction()
    {
        ...
        $block = $this->getLayout()->getBlock('customer_status');
        if ($block) {
            $block->setRefererUrl($this->_getRefererUrl());
        }
     ...
     * Forgot customer account information page
     */
    public function abonamentAction()
    {
        $this->loadLayout();
        $this->_initLayoutMessages('customer/session');
        $this->_initLayoutMessages('catalog/session');

        $block = $this->getLayout()->getBlock('customer_abonament');
        if ($block) {
            $block->setRefererUrl($this->_getRefererUrl());
        }
    ...
    public function complaintAction()
    {
        ...
        $block = $this->getLayout()->getBlock('customer_complaint');
        if ($block) {
            $block->setRefererUrl($this->_getRefererUrl());
        }
